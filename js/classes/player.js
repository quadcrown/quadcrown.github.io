class Player {
    ...
    attackoh(weapon) {
        ...
        weapon.totaldmg += done;
        weapon.totalprocdmg += procdmg;
        /* start-log */ if (log) this.log(`Off hand attack for ${done + procdmg} (${Object.keys(RESULT)[result]})${this.nextswinghs ? ' (HS queued)' : ''} ${Math.round(this.oh.dwmiss * 100) / 100} miss%`); /* end-log */
        return done + procdmg;
    }
